        ...
        <header className="max-w-6xl mx-auto px-6 pt-10 pb-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 mb-3">
            ...
            >
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white border border-slate-200 text-slate-600 px-6 py-2 rounded-full font-semibold hover:bg-slate-50 transition h-[40px] flex items-center justify-center text-sm"
            >
              Connect with Harry
            </a>
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-orange-50 text-orange-600 border border-orange-200 px-6 py-2 rounded-full font-bold hover:bg-orange-100 transition text-sm shadow-sm flex items-center gap-2"
            >
